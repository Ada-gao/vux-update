<template>
    ...
    <div class="weui-cell__bd weui-cell__primary" v-if="isASelection" :class="placeholderAlign ? `vux-x-input-placeholder-${placeholderAlign}` : ''">
      <button class="btn" :class="nationId === 1 ? 'btn-primary' : ''" @click="selectNation(1)">中国</button>
      <button class="btn" :class="nationId === 0 ? 'btn-primary' : ''" @click="selectNation(0)">其他</button>
    </div>
    <div class="weui-cell__bd weui-cell__primary"  v-if="!isASelection" :class="placeholderAlign ? `vux-x-input-placeholder-${placeholderAlign}` : ''">
      <input
      :id="`vux-x-input-${uuid}`"
